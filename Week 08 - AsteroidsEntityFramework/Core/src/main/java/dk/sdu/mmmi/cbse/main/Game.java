...
public class Game
    ...
    public void create() {
        ...
        IGamePluginService enemyPlugin = new EnemyPlugin();
                IGamePluginService astroidPlugin = new AsteroidPlugin();
        
        IEntityProcessingService playerProcess = new PlayerControlSystem();
        IEntityProcessingService enemyProcess = new EnemyControlSystem();
        IEntityProcessingService astroidProcess = new AsteroidControlSystem();
    ...
    private void draw() {
        for (Entity entity : world.getEntities()) {
            ...
            float blue = colors[2];
            float trans = colors[3];
            sr.setColor(red, green, blue, trans);
